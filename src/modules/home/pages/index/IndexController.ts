    ...
    const cards: any = [
      {
        ...
        message:
          "Registre tudo com um simples áudio e tenha informações sobre suas despesas, receitas e muito mais.",
        icon: "",
      },
      {
        title: "Segurança em primeiro lugar com seus dados financeiros",
        message:
          "Implementações de medidas rigorosas para proteger os dados dos nossos usuários.",
        icon: "",
      },
      {
        title: "Receba informações personalizadas",
        message:
          "Se supreenda com o que a inteligência artificial pode dizer sobre suas finanças.",
        icon: "",
      },
    ];
    const cards2: any = [
